...
const PromotionalContentAreas = () => {
    ...
    const rowData = [
        {
            id: 1,
            name: 'Code that you never miss',
            arabicname: 'كود لا يفوتك',
            type: 'Brand',
            typedata: 'General Supreme',
            status: 'Disable',
        },
    ];

    useEffect(() => {
        dispatch(setPageTitle('Product Content Areas Listing'));
    });
                ...
                <div className="mb-4.5 flex md:items-center md:flex-row flex-col gap-5">
                    <div className="flex items-center gap-2">
                        ...
                        <Link to="/discountrules/newrule" className="btn btn-primary gap-2">
                            <IconPlus />
                            Create Promotional Content Areas
                        </Link>
                    </div>
...
export default PromotionalContentAreas;
