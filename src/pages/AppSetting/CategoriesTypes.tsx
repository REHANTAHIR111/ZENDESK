...
const Rules = () => {
    ...
    const rowData = [
        {
            id: 1,
            name: 'Save up to 40% on TV & Enterainment',
            arabicname: 'وفر حتى 40٪ على التلفاز',
            category: 'Television',
            viewtype: 'Horizontal',
            position: 'First',
            status: 'Enable',
    ...
    useEffect(() => {
        dispatch(setPageTitle('Category Type'));
    });
                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                title: 'Category',
                                sortable: true,
                                render: ({ category }: any) => <div className="font-semibold">{category}</div>,
                            },
                            {
                                accessor: 'viewtype',
                                title: 'View Type',
