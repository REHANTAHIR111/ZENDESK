...
const MarktetingBanners = () => {
    ...
    const rowData = [
        {
            id: 1,
            mbname: 'Air Condition',
            mbnamear: '',
            image: 'https://cdn-media.tamkeenstores.com.sa/cdn-cgi/imagedelivery/Jw_qf5oljXy0QDE-Fq4W9Q/558ea80f-4f8d-488b-c08c-d36cd031a400/productimages',
            imagearabic: 'https://cdn-media.tamkeenstores.com.sa/cdn-cgi/imagedelivery/Jw_qf5oljXy0QDE-Fq4W9Q/558ea80f-4f8d-488b-c08c-d36cd031a400/productimages',
            type: 'Category',
            typedata: 'Air Conditioners',
            position: 'First',
            status: 'Enable',
        },
    ];
    ...
    useEffect(() => {
        dispatch(setPageTitle('Marketing Banner Listing'));
    });
                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                title: 'MB Name - En',
                                sortable: true,
                                render: ({ mbname }: any) => <div className="font-semibold">{mbname}</div>,
                            },
                            {
                                accessor: 'mbnamear',
                                title: 'MB Name - Ar',
                                sortable: true,
                                render: ({ mbnamear }: any) => <div className="font-semibold font-serif text-right">{mbnamear}</div>,
                            },
                            {
                                accessor: 'image',
                                title: 'Image',
...
export default MarktetingBanners;
