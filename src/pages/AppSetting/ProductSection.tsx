...
const ProductSection = () => {
    ...
    const rowData = [
        {
            id: 1,
            psname: 'Buy X get Y',
            psnamear: 'Free Installation',
            notes: 'This rule having a free installation based on sepcific cities.',
            startdate: 'Sep 23, 2023 | 03:23 PM',
            enddate: 'Nov 23, 2023 | 03:23 PM',
            status: 'Active',
        },
        {
            id: 2,
            psname: 'Product Adjustment',
            psnamear: 'Product Adjustment | GS30034',
            notes: 'This is 10% Cashback Pormotion that based on 10% Cashback category, this is only for Generalsupreme, Kiriazi, GoldTech products on all products.',
            startdate: 'Sep 23, 2023 | 03:23 PM',
            enddate: 'Nov 23, 2023 | 03:23 PM',
            status: 'Disabled',
        },
    ...
    useEffect(() => {
        dispatch(setPageTitle('Product Section Listing'));
    });
                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                title: 'PS Name - En',
                                sortable: true,
                                render: ({ psname }: any) => <div className="font-semibold">{psname}</div>,
                            },
                            {
                                accessor: 'psnamear',
                                title: 'PS Name - Ar',
                                sortable: true,
                                render: ({ psnamear }: any) => <div className="font-semibold font-serif">{psnamear}</div>,
                            },
                            {
                                accessor: 'startdate',
                                title: 'Start Date',
                                sortable: true,
                                render: ({ startdate }: any) => <div className="font-semibold">{startdate}</div>,
                            },
                            {
                                accessor: 'enddate',
                                title: 'End Date',
                                sortable: true,
                                render: ({ enddate }: any) => <div className="font-semibold">{enddate}</div>,
                            },
                            {
                                accessor: 'status',
                                title: 'Status',
                            ...
                            },
                            {
                                ...
                                title: 'Notes',
                                sortable: true,
                                render: ({ notes }: any) => <div className="font-semibold">{notes}</div>,
                            },
                            {
                                accessor: 'action',
                                title: 'Action',
