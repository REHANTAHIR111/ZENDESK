...
const Rules = () => {
    ...
    const rowData = [
        {
            id: 1,
            name: 'white-friday-offers',
            arabicname: '',
            image: 'https://cdn-media.tamkeenstores.com.sa/cdn-cgi/imagedelivery/Jw_qf5oljXy0QDE-Fq4W9Q/0bcf4211-c6b9-43d5-9f19-1f8cb1139600/productimages',
            imagearabic: 'https://cdn-media.tamkeenstores.com.sa/cdn-cgi/imagedelivery/Jw_qf5oljXy0QDE-Fq4W9Q/0bcf4211-c6b9-43d5-9f19-1f8cb1139600/productimages',
            vediolink: 'https://media.tamkeenstores.com.sa/videos/760x1000.webm',
            vediointerval: '7.5',
            type: 'Category',
            typedata: 'White Friday Sale',
            sorting: '1',
            status: 'Enable',
        },
    ];
    ...
    useEffect(() => {
        dispatch(setPageTitle('App Slider Listing'));
    });
                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                title: t('image'),
                                sortable: true,
                                render: ({ image }: any) =><img src={image} width="50" alt="" />,
                            },
                            {
                                accessor: 'imagearabic',
                                title: t('imageArabic'),
                                sortable: true,
                                render: ({ imagearabic }: any) => <img src={imagearabic} width="50" alt="" />,
                            },
                            {
                                accessor: 'vediolink',
                                title: t('vediolink'),
                                sortable: true,
                                render: ({ vediolink }: any) => <div className="font-semibold">{vediolink}</div>,
                            },
                            {
                                accessor: 'vediointerval',
                                title: t('vediointerval'),
                                sortable: true,
                                render: ({ vediointerval }: any) => <div className="font-semibold">{vediointerval}</div>,
                            },
                            {
                                accessor: 'type',
                                title: t('type'),
                            ...
                            },
                            {
                                ...
                                title: t('sorting'),
                                sortable: true,
                                render: ({ sorting }: any) => <div className="font-semibold">{sorting}</div>,
                            },
                            {
                                accessor: 'status',
                                title: t('status'),
