...
const Departments = (props: any) => {
  ...
  const [modal, setModal] = useState<any>(false);
    ...
    const key = 'draggable-example1010';
    ...
    return (
        <>
            <div className="">
                <div className="flex mb-3 w-full justify-between">
                    <div className='gap-3 flex'>
                        ...
                        <button className='btn btn-sm shadow-none hover:bg-[#5293C7] rounded text-white h-8 bg-[#3681BE]' onClick={() => {localStorage.setItem('header','Add department'), navigate('/zendesk/department/add-departments')}}>Add department</button>
                    </div>
                    <label className='text-sm pt-1.5 font-normal'>0 enabled / 2 departments</label>
                </div>
            ...
            <div className='flex justify-center gap-3'>
                <p className='mt-1.5 font-light text-base text-gray-600'>Use departments to organize your agents into different teams.</p>
