            ...
            <div className='w-[44%]'>
              ...
              {!cusImg ?
                ...
                : ''}
                  {!textOnly ?
                      <div className={`w-full flex mt-5 ${of ? 'text-[#DBDBDB]' : ''}`}>
                        ...
                        <img src='https://v2assets.zopim.io/JHCfOsl2bT75lsNA6tisF9vp3LQiGPaV-banner?1668554852212' className='w-[3.6rem] h-[3.6rem]' />
                        <div className='ml-4'>
                          <button type='button' className='h-[1.9rem] px-4 py-1.5 font-bold rounded text-xs border hover:bg-gray-200 duration-150'>Choose from gallery</button>
                          <div className='flex gap-3 mt-3'>
                            <button type='button' className='h-[1.9rem] px-4 py-1.5 font-bold rounded text-xs border hover:bg-gray-200 duration-150'>Upload image</button>
                            <button type='button' className='h-[1.9rem] px-4 py-1.5 font-bold rounded text-xs border hover:bg-gray-200 duration-150'>Remove</button>
                          </div>
                ...
                <div className='mt-5 bg-[#EEEEEE] py-2 px-3 border-l-2 border-[#999999]'>
                    ...
                    <span className='font-bold mt-1 ml-1 text-[13px] text-gray-600'>Settings {'>'} Personal</span>
                </div>
                        ...
                        : webWid ?
                            <>
                              <div className='w-[48%]'>
                                  ...
                                  <select id="countries" searchable className={`${blockOf ? 'bg-gray-50' : ''} form-multiselect text-xs border rounded hover:border px-1 hover:border-blue-500 w-52 h-[1.9rem] my-1`} disabled={blockOf}>
                                      <option>China</option>
