...
const IconUser: FC<IconUserProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <>
            {!fill ? (
                <svg width="18" fill="#A7B4B5" height="18" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg" className={className}>
                ...
                <svg width="18" fill="#A7B4B5" height="18" viewBox="0 0 18 18" className={className}>
                    <circle cx="9" cy="4.5" r="3"  stroke='gray' stroke-width='1.5' />
                    <path
